...
#ifndef EZM_SPI_FLASH_ARCH_COMMON_H_
#define EZM_SPI_FLASH_ARCH_COMMON_H_
...
typedef enum
{
	EZM_SPI_FLASH_ARCH_E_READY = -1,
	EZM_SPI_FLASH_ARCH_OK = 0,
}ezm_arch_spi_flash_err_t;

typedef void (*ezm_spi_flash_arch_rx_it_hdle)(void * spi_hdle, uint8_t * data, uint16_t data_size);
 ...
 * @return
 */
int ezm_spi_flash_arch_init_spi(void * spi_hdle, ezm_spi_flash_arch_rx_it_hdle spi_rx_it_hdle);
/**
 * @brief Poll read SPI.
 *
 * @param buffer Buffer.
...
#endif /* EZM_SPI_FLASH_ARCH_COMMON_H_ */
